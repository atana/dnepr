//////////////////////////////////////////////////////////////////////////////
// Filename:          C:\Xilinx\10.1\edk_user_repository\MyProcessorIPLib/drivers/plb34_reg_version_v1_00_a/src/plb34_reg_version_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the plb34_reg_version driver
...
XStatus PLB34_REG_VERSION_SelfTest(void * baseaddr_p)
{
   ...
   PLB34_REG_VERSION_mWriteSlaveReg0(baseaddr, 1);
   Reg32Value = PLB34_REG_VERSION_mReadSlaveReg0(baseaddr);

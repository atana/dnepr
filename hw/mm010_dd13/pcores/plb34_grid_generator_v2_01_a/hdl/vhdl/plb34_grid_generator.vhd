------------------------------------------------------------------------------
-- plb34_grid_generator.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb34_grid_generator.vhd
-- Version:           2.01.a
-- Description:       Top level design, instantiates IPIF and user logic.
-- Date:              Mon Mar 29 18:03:42 2010 (by Create and Import Peripheral Wizard)
...
library plb34_grid_generator_v2_01_a;
use plb34_grid_generator_v2_01_a.all;
...
entity plb34_grid_generator is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
		DISCRETE_NUMBER_SHIFT			: std_logic_vector  := x"00040030"; --48
...
--		SIMULATION 							: boolean := true;       -- for TIMESIM
    ...
    C_HIGHADDR                     : std_logic_vector     := X"0000000F";
...
end entity plb34_grid_generator;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb34_grid_generator is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb34_grid_generator_v2_01_a.user_logic
    generic map
    (
      -- MAP USER GENERICS BELOW THIS LINE ---------------
				DISCRETE_NUMBER_SHIFT => DISCRETE_NUMBER_SHIFT,

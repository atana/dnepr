------------------------------------------------------------------------------
-- plb34_period_test.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb34_period_test.vhd
-- Version:           1.00.a
...
library plb34_period_test_v1_00_a;
use plb34_period_test_v1_00_a.all;
...
entity plb34_period_test is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
			-- Параметры длительности импульса
        Pulse_UP_LIMIT   	: std_logic_vector(31 downto 0):= X"0000_0029"; 
        Pulse_DOWN_LIMIT 	: std_logic_vector(31 downto 0):= X"0000_0027";
		  Pulse_RESET_FRAME 	: std_logic_vector(31 downto 0):= X"0000_002A";
			-- Параметры периода
	     Period_UP_LIMIT   	: std_logic_vector(31 downto 0):= X"0000_0000"; 
        Period_DOWN_LIMIT 	: std_logic_vector(31 downto 0):= X"0000_0000";
		  Period_RESET_FRAME : std_logic_vector(31 downto 0):= X"0000_0000"; 
    ...
    C_HIGHADDR                     : std_logic_vector     := X"0000001F";
...
end entity plb34_period_test;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb34_period_test is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb34_period_test_v1_00_a.user_logic
    generic map
    (
      -- MAP USER GENERICS BELOW THIS LINE ---------------
				Pulse_UP_LIMIT   		=> Pulse_UP_LIMIT,  	
				Pulse_DOWN_LIMIT 	   => Pulse_DOWN_LIMIT, 	 
				Pulse_RESET_FRAME 	=> Pulse_RESET_FRAME, 
                                                      
				Period_UP_LIMIT   	=>	Period_UP_LIMIT,   		  
				Period_DOWN_LIMIT 	=>	Period_DOWN_LIMIT, 		  
				Period_RESET_FRAME 	=>	Period_RESET_FRAME, 	  

...
entity user_logic is
  ...
  (
    ...
    --USER generics added here
		DISCRETE_NUMBER_SHIFT			:  std_logic_vector:= x"00030000"; --48;
...
--				SIMULATION : boolean := false
	...
	Port (
			...
			SYNC_CLK_50kHz_SHIFT		:in  std_logic_vector(6 downto 0):= "0000000"; -- плавный сдвиг импульса 50к√ц (1 шаг 1 импульс 40ћ√ц)
			Bus2IP_Reset				:in  std_logic;
			Bus2IP_Clk					:in  std_logic;
			CLK_EXT_19Hz				:in  std_logic;
			CLK_EXT_1_25MHz			:in  std_logic;
...
begin
  ...
  begin
    ...
    case slv_reg_read_select is
      when "1000" => slv_ip2bus_data <= x"10060201";
...
Grid_Gen_inst: Grid_Gen
			generic map(
				...
				Port Map(
							...
							SYNC_CLK_50kHz_SHIFT	 	 => REG_DISCRETE_NUMBER_SHIFT(22 downto 16),

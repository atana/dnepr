------------------------------------------------------------------------------
-- plb34_grid_generator125.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb34_grid_generator10.vhd
-- Version:           3.00.a
-- Description:       Top level design, instantiates IPIF and user logic.
-- Date:              Tue Feb 21 16:07:05 2012 (by Create and Import Peripheral Wizard)
...
library plb34_grid_generator125_v3_00_a;
use plb34_grid_generator125_v3_00_a.all;
...
entity plb34_grid_generator125 is
  ...
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
		DISCRETE_NUMBER_SHIFT			: std_logic_vector  := x"00040000"; --48
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb34_grid_generator125_v3_00_a.user_logic
    generic map
    (
    ...
    (
      -- MAP USER PORTS BELOW THIS LINE ------------------
				...
				CLK_EXT_1_25MHz	                  => CLK_EXT_1_25MHz,  

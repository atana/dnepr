------------------------------------------------------------------------------
-- plb34_freq_test.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library plb34_freq_test_v1_00_a;
use plb34_freq_test_v1_00_a.all;
...
entity plb34_freq_test is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
			  UP_LIMIT   		: std_logic_vector(31 downto 0):= X"0271_9C40";
			  DOWN_LIMIT 		: std_logic_vector(31 downto 0):= X"0253_17C0";
			  START_FRAME		: std_logic_vector(31 downto 0):= X"0000_0020";
			  END_FRAME  		: std_logic_vector(31 downto 0):= X"05f5_e120";
			  RESET_FRAME_CLK	: std_logic_vector(31 downto 0):= X"05f5_e140";
...
end entity plb34_freq_test;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb34_freq_test is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb34_freq_test_v1_00_a.user_logic
    generic map
    (
      -- MAP USER GENERICS BELOW THIS LINE ---------------
			  ...
			  END_FRAME  		=> END_FRAME,  		
			  RESET_FRAME_CLK	=> RESET_FRAME_CLK,	    
			  C_AUTOSET		=> C_AUTOSET,

...
entity user_logic is
  ...
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
		...
		C_ID								   : std_logic_vector:= x"01180000";  
...
architecture IMP of user_logic is
  ...
  constant VERSION 						: std_logic_vector(31 downto 0):= C_VERSION;
  constant ID		 						: std_logic_vector(31 downto 0):= C_ID;
  ------------------------------------------
...
begin
  ...
  begin
    ...
    case slv_reg_read_select is
      when "10" => slv_ip2bus_data <= ID;
      when "01" => slv_ip2bus_data <= VERSION;

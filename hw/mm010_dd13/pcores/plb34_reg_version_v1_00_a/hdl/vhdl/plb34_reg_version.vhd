------------------------------------------------------------------------------
-- plb34_reg_version.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb34_reg_version.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates IPIF and user logic.
-- Date:              Thu Mar 11 10:05:35 2010 (by Create and Import Peripheral Wizard)
...
entity plb34_reg_version is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
		C_VERSION                     : std_logic_vector     := X"56455253";     
		C_ID		                     : std_logic_vector     := X"01180000"; -- cell's ID (x01180001, x01190000, x01190001)     
...
end entity plb34_reg_version;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb34_reg_version is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb34_reg_version_v1_00_a.user_logic
    generic map
    (

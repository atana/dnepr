//////////////////////////////////////////////////////////////////////////////
// Filename:          D:\TEST\HW_SW_test\sym_plb34_grid_generator/drivers/plb34_grid_generator_v2_01_a/src/plb34_grid_generator.h
// Version:           2.01.a
...
#define PLB34_GRID_GENERATOR_SLAVE_REG3_OFFSET (PLB34_GRID_GENERATOR_USER_SLAVE_SPACE_OFFSET + 0x0000000C)
...
#define PLB34_GRID_GENERATOR_mWriteSlaveReg3(BaseAddress, Value) \
 	XIo_Out32((BaseAddress) + (PLB34_GRID_GENERATOR_SLAVE_REG3_OFFSET), (Xuint32)(Value))
...
#define PLB34_GRID_GENERATOR_mReadSlaveReg3(BaseAddress) \
 	XIo_In32((BaseAddress) + (PLB34_GRID_GENERATOR_SLAVE_REG3_OFFSET))

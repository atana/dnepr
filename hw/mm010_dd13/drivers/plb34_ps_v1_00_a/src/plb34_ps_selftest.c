//////////////////////////////////////////////////////////////////////////////
// Filename:          D:\temp\6MPGM_6MPS5_6B261_6A119_7M010_DD13\system/drivers/plb34_ps_v1_00_a/src/plb34_ps_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the plb34_ps driver
...
XStatus PLB34_PS_SelfTest(void * baseaddr_p)
{
   ...
   PLB34_PS_mWriteSlaveReg0(baseaddr, 1);
   Reg32Value = PLB34_PS_mReadSlaveReg0(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg1(baseaddr, 2);
   Reg32Value = PLB34_PS_mReadSlaveReg1(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg2(baseaddr, 3);
   Reg32Value = PLB34_PS_mReadSlaveReg2(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg3(baseaddr, 4);
   Reg32Value = PLB34_PS_mReadSlaveReg3(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg4(baseaddr, 5);
   Reg32Value = PLB34_PS_mReadSlaveReg4(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg5(baseaddr, 6);
   Reg32Value = PLB34_PS_mReadSlaveReg5(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg6(baseaddr, 7);
   Reg32Value = PLB34_PS_mReadSlaveReg6(baseaddr);
   ...
   PLB34_PS_mWriteSlaveReg7(baseaddr, 8);
   Reg32Value = PLB34_PS_mReadSlaveReg7(baseaddr);
